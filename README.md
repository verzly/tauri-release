...
```sh
cargo install --git https://github.com/verzly/tauri-release --tag v0.2.3 --force
```
...
```text
tauri-release-v0.2.3-<rust-host-target>
tauri-release-v0.2.3-<rust-host-target>.exe
```
...
```sh
curl -L -o tauri-release https://github.com/verzly/tauri-release/releases/latest/download/tauri-release-v0.2.3-x86_64-unknown-linux-gnu
...
```powershell
Invoke-WebRequest -Uri "https://github.com/verzly/tauri-release/releases/latest/download/tauri-release-v0.2.3-x86_64-pc-windows-msvc.exe" -OutFile "tauri-release.exe"
